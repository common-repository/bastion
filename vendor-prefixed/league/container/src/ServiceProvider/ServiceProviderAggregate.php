...
use Generator;
use Bastion\Dependencies\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
...
class ServiceProviderAggregate implements ServiceProviderAggregateInterface
{
    ...
    public function add($provider) : ServiceProviderAggregateInterface
    {
        ...
        throw new ContainerException(
            ...
            'of (\Bastion\Dependencies\League\Container\ServiceProvider\ServiceProviderInterface)'
        );
    }
